...
<input type="checkbox" id="chec">
    ...
    <div class="sup-prod">
        <h1 class="viz">Alterar descrição</h1>
        <div class="verProd">
        <div class="Scroll">
            <table width="100%" class="zebra">
                ...
                <tr>
                    ...
                    <td><a class="botao" href="alterarDescricao.php?id=<?=$estoque->getId();?>">Editar</a> 
                    <a class="botao" href="../dataBase/excluir.php?id=<?=$estoque->getId();?>" onclick="return confirm('tem certeza que deseja excluir?')">Excluir</a></td>
                <?php }?>
                </div>
            </table>
        </div>
